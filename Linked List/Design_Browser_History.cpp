...
gfg link --> https://practice.geeksforgeeks.org/problems/design-browser-history/1
...
list<string>history;
 list<string>::iterator it;
    ...
    // visit current url  -->visit meaning deleting the before link(page) and connecting to new link(page)
